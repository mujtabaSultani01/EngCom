...
?>
 <?php
         ...
         if(isset($_POST["name"])){
          ...
          if ($ptitle =="" || $pbody =="" || $pimage =="") {
            echo "<span style='color:red;'>please fill all the fields!!!</span>";
          }
          else
          {
            $query="INSERT INTO `products` (`name`, `body`, `image`) 
            VALUES ($ptitle', '$pbody', '$pimage');";
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i><img id="ico" src="../public/icons/project.png" height="40" width="40"></i>Published Form Validation</h3>
            <ol class="breadcrumb">
              <li><i><img id="ico" src="../public/icons/home.png" height="15" width="15"></i><a href="../adminpanel/A_index.php">Home</a></li>
              <li><i><img id="ico" src="../public/icons/project.png" height="15" width="15"></i>Published</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
   ...
   <div class="row">
        ...
        <?php do{ ?>
                  <tr>
                    ...
                    <td><img style="border-radius:20px; width:130; height:160px;" src="../public/images/portfolio/full/<?php echo $row["image"]; ?>"  width="250" height="200"> </td>
                   
                     <td>
                      <div class="btn-group">
                        <a class="btn btn-success" href="updatePages/productupdate.php?ID=<?php echo $row["id"]; ?>"><i class="icon_check_alt2"></i></a> 
                        <a class="btn btn-danger" class="icon_close_alt2" href="deletePages/productdelete.php?ID=<?php echo $row["id"]; ?>"><i class="icon_check_alt2"></i></a>                        
                      </div>
                    </td>
                  </tr>
                </tbody>
