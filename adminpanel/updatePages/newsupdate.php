...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-files-o"></i>News Update</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
        <div class="row">
         ...
         $recordSet=mysql_query("SELECT * FROM `news` WHERE id=$getID",$con);
   ...
   mysql_query("UPDATE `news` SET `title` = '$ntitle', `body` = '$nbody', `image` = '$nimage'  WHERE `news`.`id` = $getID; ",$con);
     echo "record Updated...";
      }
  ?>
                  </form>
