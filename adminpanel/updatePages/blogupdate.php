...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="fa fa-files-o"></i>Blogs Update</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
        <div class="row">
         ...
         $recordSet=mysql_query("SELECT * FROM `blog` WHERE id=$getID",$con);
        $row=mysql_fetch_assoc($recordSet);
       
            ?>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Service Title <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class="form-control" id="s_title" name="title" minlength="5" type="text" value="<?php echo $row["title"]; ?>"/>
                      </div>
                    </div>
                    <div class="form-group ">
                    ...
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Service Image <span class="required">*</span></label>
                      <div class="col-lg-10">
   ...
   mysql_query("UPDATE `blog` SET `title` = '$btitle', `postman` = '$bpostman', `body` = '$bbody', `image` = '$bimage'  WHERE `blog`.`id` = $getID; ",$con);
     echo "record Updated...";
      }
  ?>
                  </form>
