...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Course Information</li>
              <li><i class="fa fa-files-o"></i>CourseInfromation Update</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
        <div class="row">
         ...
         $recordSet=mysql_query("SELECT * FROM `courseinfo` WHERE id=$getID",$con);
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="s_image" name="image" type="file" 
                          /><img src="../../public/images/<?php echo $row["image"];?>" width="100" height="100">
                      </div>
                    </div>
                    <div class="form-group">
   ...
   mysql_query("UPDATE `courseinfo` SET `title` = '$stitle', `body` = '$sbody', `image` = '$simage'  WHERE `courseinfo`.`id` = $getID; ",$con);
     echo "record Updated...";
      }
  ?>
                  </form>
