...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li><i class="icon_document_alt"></i>Favorites</li>
              <li><i class="fa fa-files-o"></i>Favorites Update</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
        <div class="row">
         ...
         $recordSet=mysql_query("SELECT * FROM `favorites` WHERE id=$getID",$con);
        $row=mysql_fetch_assoc($recordSet);
       
            ?>
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-2">Favorites Icon <span class="required">*</span></label>
                      <div class="col-lg-10">
   ...
   mysql_query("UPDATE `favorites` SET `icon` = '$ficon', `title` = '$ftitle', `body` = '$fbody'  WHERE `favorites`.`id` = $getID; ",$con);
     echo "record Updated...";
      }
  ?>
                  </form>
