 <?php
                        ...
                        if(isset($_POST["usname"])){
                            ...
                            $pass=$_POST["password"];
                        $res=
                        mysql_query("SELECT * FROM `teacher` WHERE uname='$uname' AND password='$pass' ",$con);
                        ...
                        if (mysql_num_rows($res) > 0) {
                             ...
                             $clque=mysql_query("SELECT clname FROM `teacher_attend` WHERE t_id=$tid",$con);
                             ...
                             if (mysql_num_rows($clque) > 1) {
                               ...
                               header("location:multipleLoginForTeacher.php");
                             }
                             else{
                              //echo $clname;
                              if ($clname=='Step-1') {
 ...
 <html lang="en" class="no-js">
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>Login As Teacher To -><span> "Lemar Academy"</span></h1>
            </header>
            <section>				
