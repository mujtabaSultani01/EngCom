 <?php
                        ...
                        if(isset($_POST["usname"])){
                            ...
                            $pass=$_POST["password"];
                        $res=
                        mysql_query("SELECT * FROM `student` WHERE uname='$uname' AND password='$pass' ",$con);
                        ...
                        if (mysql_num_rows($res) > 0) {
                             ...
                             $clque=mysql_query("SELECT clname FROM `attend` WHERE stid=$sid",$con);
                             $rows=mysql_fetch_assoc($clque);
                             $clname= $rows["clname"];

                             if (mysql_num_rows($clque) > 1) {

                               $_SESSION['mySession'] = $img;
                               header("location:multipleLoginForStudent.php");
                             }
                             else{
                              //echo $clname;
                              if ($clname=='Step-1') {
                             ...
                             echo "<span style='color:red;'>Username and Password don't match!!!</span>";
                        }
 ...
 <html lang="en" class="no-js">
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1>Login As <b style="color:green">Student</b> To -><span> "Lemar Academy"</span></h1>
            </header>
            <section>				
