  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i><img id="ico" src="../public/icons/gallery.png" height="40" width="40"></i>Gallery Form Validation</h3>
            <ol class="breadcrumb">
              <li><i><img id="ico" src="../public/icons/home.png" height="15" width="15"></i><a href="../adminpanel/A_index.php">Home</a></li>
              <li><i><img id="ico" src="../public/icons/gallery.png" height="15" width="15"></i>Gallery</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
   ...
   <!-- page end-->
    <div class="row">
          <div class="col-lg-12">
            <section class="panel">
              ...
              <table class="table table-striped table-advance table-hover">
                <tbody>
                  <tr>
                    <th><i></i>Gallery Images</th>
                    <th><i class="icon_cogs"></i> Action</th>
                  </tr>
                    
        <?php
          include 'ConPage.php';
          $recordSet = mysql_query("SELECT * FROM `gallery`");
        ...
        <?php do{ ?>
                  ...
                  <tr>
                    <td><img src="../public/images/gallary/<?php echo $row["image"]; ?>" width="200" height="120"></td>
                     <td>
                      <div class="btn-group">
                        <a class="btn btn-success" href="updatePages/galleryupdate.php?ID=<?php echo $row["id"]; ?>"><i class="icon_check_alt2"></i></a> 
                        <a class="btn btn-danger" class="icon_close_alt2" href="deletePages/gallerydelete.php?ID=<?php echo $row["id"]; ?>"><i class="icon_check_alt2"></i></a>                        
                      </div>
                    </td>
                  </tr>
                </tbody>
