...
<?php
         ...
         if(isset($_POST["title"])){
          ...
          $btitle=$_POST["title"];
          $bpostman=$_POST["postman"];
          $bbody=$_POST["body"];
          $bimage=$_POST["image"];
        
          if ($btitle =="" || $bpostman =="" || $bbody =="" || $bimage =="") {
            echo "<span style='color:red;'>please fill all the fields!!!</span>";
          }
          else
          {
            $query="INSERT INTO `blog` (`title`, `postman`, `body`, `image`) 
            VALUES ('$bid', '$btitle', '$bpostman', '$bbody', '$bimage');";
...
<body>
  ...
  <section id="container" class="">
    ...
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i><img id="ico" src="../public/icons/announcement.png" height="40" width="40"></i>Announcement Form Validation</h3>
            <ol class="breadcrumb">
              <li><i><img id="ico" src="../public/icons/home.png" height="15" width="15"></i><a href="../adminpanel/A_index.php">Home</a></li>
              <li><i><img id="ico" src="../public/icons/announcement.png" height="15" width="15"></i>Announcement</li>
            </ol>
          </div>
        </div>
        <!-- Form validations -->
                ...
                <div class="form">
                  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="">
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="s_title" name="title" minlength="5" type="text" required />
                      </div>
                    </div>
                     <div class="form-group ">
                      <label for="cemail" class="control-label col-lg-2"> PostMan <span class="required">*</span></label>
                      <!-- <div class="col-lg-10">
                    ...
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class="form-control" id="s_image" name="image" minlength="5" type="file" required />
                      </div>
                    </div>
                    <div class="form-group">
 ...
 <div class="row">
          ...
          include 'ConPage.php';
          $recordSet=
          mysql_query("SELECT * FROM `blog` ",$con);
        ...
        <?php do{ ?>
                  <tr>
                    ...
                    <td><?php echo $row["postman"]; ?></td>
                    <td width="400"><?php echo $row["body"]; ?></td>
                    <td><img src="../public/images/blog/<?php echo $row["image"]; ?>"  width="200" height="200"> </td> 
                    <td>
                      <div class="btn-group">
                        <a class="btn btn-success" href="updatePages/blogupdate.php?ID=<?php echo $row["id"]; ?>"><i class="icon_check_alt2"></i></a> 
                        <a class="btn btn-danger" class="icon_close_alt2" href="deletePages/blogdelete.php?ID=<?php echo $row["id"]; ?>"><i class="icon_check_alt2"></i></a>                        
                      </div>
                    </td>
                  </tr>
                </tbody>
