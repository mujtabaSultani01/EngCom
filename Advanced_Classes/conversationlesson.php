            ...
            <div class="row">
                <div class="span7">
                    <header class="page-header">
                        <center><h3> BCP (Big Classes Package) <br/>
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='Conversation'",$con);
    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          else
          {
            ...
            $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='Conversation'",$con);
