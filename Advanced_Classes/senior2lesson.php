                ...
                <div class="span7">
                    <header class="page-header">
                        <center><h3> ACP (Advanced Classes Package) <br/>
                            <small> Senior-2 Class goes here</small>
                        </h3></center>
                    </header>
                </div>
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='Senior-2'",$con);
    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          else
          {
            ...
            $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='Senior-2'",$con);
