    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          else
          {
            ...
            $query="INSERT INTO `homework` (`name`, `fname`,`body`, `file`, `classname`) 
            VALUES ('$name', '$fname','$bodytext', '$file', '$classname');";
          mysql_query($query,$con);

            $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='MS.excel_qit'",$con);
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          else
          {
            ...
            $query="INSERT INTO `attendence` (`Sname`, `Simage`, `classname`,`student_id`) 
            VALUES ('$name', '$image', '$classname','$studentid');";
          mysql_query($query,$con);
          
          $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='MS.excel_qit'",$con);
