...
session_start();
  ...
  if (!isset($_SESSION['computerHardwarelogin'])) {
                      ...
                      <div class="body-nav body-nav-vertical" >
                        <div class="container">
                            <ul>
                                ...
                                <li>
                                    <a href="computerHardwarelesson.php" id="less">
                    ...
                    <div class="span9">
                        <ul class="nav nav-pills">
                         ...
                         <?php
                                ...
                                $studentid=$_SESSION['computerHardwarelogin'];
                           ...
                           ?>
                                 <ul class="dropdown-menu">
                                        <li>
                                            <a href='stu_profile.php?stid=<?php echo $studentid ?> & Clname=ComputerHardware.php '>update profile</a>
                                        </li>
                                        <li>
    ...
    <section class="page container">
        <div class="row">
            <div class="span8">
                <div class="box">
                    <div class="box-header">
                        ...
                        <h5>computerHardware Class Images</h5>
                    </div>
                        <?php
                          include '../../adminpanel/ConPage.php';
                          $recordSet = mysql_query("SELECT * FROM `gallery` WHERE classname = 'computerHardware' ");
            ...
            <div class="span8">
                <div class="blockoff-left">
                    <legend class="lead">
                      <p>Welcome To <b id="bo">computerHardware</b> Class</p>
                    </legend>
                    <p>
                            ...
                            <div class="box-content box-table">
                                ...
                                <table id="sample-table" class="table table-hover table-bordered tablesorter">
                                    <thead>
                                       ...
                                       <?php
                                      $recordSet=
                                      mysql_query("SELECT stu_name,stu_Fname,marks FROM `stu_marks` WHERE (classname='ComputerHardware' AND test_name='$testname') AND (stu_name='$user_name' AND stu_Fname='$user_fname')",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                   <?php do{ ?>
                                    <tbody>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                      $re=
                                      mysql_query("SELECT stu_name,stu_Fname,SUM(marks) as total FROM `stu_marks` WHERE classname='ComputerHardware' AND (stu_name='$user_name' AND stu_Fname='$user_fname') GROUP BY stu_name ORDER BY total DESC",$con);
                    ...
                    <div class="span8">
                        <div class="box" id="coursefollwers" style="display:none">
                           ...
                           <table>
                             ...
                             include '../../adminpanel/ConPage.php';
                             $recordSet=
                             mysql_query("SELECT * FROM `student` as stu, `attend` as att WHERE stu.image!='$userimage' AND (stu.st_id=att.stid AND att.clname='computerHardware')",$con);
                             $row=mysql_fetch_assoc($recordSet);
                           ...
                           <td></td> <td></td><td></td>
                           <td><i><a href="stu_message/msg-bet-stu-computerhardware.php?stid=<?php echo $row["image"]; ?>"><img src="../public/images/icons/small/message.png"></a></i></td> 
                            </tr>
                            <?php }while($row=mysql_fetch_assoc($recordSet));?>
        ...
        <div class="row">
             <div class="span8" id="publicmessage" style="display:none">
               <div class="box">
                   ...
                   <div class="box-content">
                    ...
                    <?php
                        $recordSet=
                         mysql_query("SELECT * FROM `smessage` WHERE classname='computerHardware' AND type='public' ",$con);
                        $row=mysql_fetch_assoc($recordSet);
                    ?>
                    <?php do{ ?>
         ...
         if(isset($_POST["pubody"])){
          ...
          $Set=
            mysql_query("SELECT MAX(id) as mid FROM `smessage` WHERE classname='ComputerHardware'",$con);
...
?>
              <div class="span8" id="privatemessage" style="display:none">
                <div class="box">
                    ...
                    <div class="box-content">
                        <div class="form-group">
                    <?php // SELECT * FROM `smessage`,`student` WHERE student.password=smessage.password AND classname='computerHardware' 
