...
session_start();
  ...
  if (!isset($_SESSION['advancedTwologin'])) {
...
<head>
    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='Advanced-2'",$con);
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='Advanced-2'",$con);
