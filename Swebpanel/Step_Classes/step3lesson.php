...
<head>
                         ...
                         <?php
                           ...
                           ?>
                                 <ul class="dropdown-menu">
                                        <li>
                                            <a href='stu_profile.php?stid=<?php echo $studentid ?> & Clname=step-3.php '>update profile</a>
                                        </li>
                                        <li>
    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='Step-3'",$con);
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          mysql_query($query,$con);
           ...
           $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='Step-3'",$con);
