    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          mysql_query($query,$con);
            ...
            $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='audio_video_editing'",$con);
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='audio_video_editing'",$con);
