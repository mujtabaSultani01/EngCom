                ...
                <div class="box">
                    <div class="box-content">
                        ...
                        <?php
                                    include '../../adminpanel/ConPage.php';
                                      $recordSet=
                                      mysql_query("SELECT * FROM `lessons` WHERE classname='plotagon2016'",$con);
                    ...
                    <div class="box-content box-list collapse in">
                        ...
                        <ul>
                             <?php
                                    include '../../adminpanel/ConPage.php';
                                      $recordSet=
                                      mysql_query("SELECT * FROM `documents` WHERE classname='plotagon2016'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                   <?php do{ ?>
                            <li>
    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          mysql_query($query,$con);
            ...
            $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='plotagon2016'",$con);
...
<?php
         ...
         $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='plotagon2016'",$con);
