    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          mysql_query($query,$con);
            ...
            $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='adobe_muse_cc2018'",$con);
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          mysql_query($query,$con);
           ...
           $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='adobe_muse_cc2018'",$con);
