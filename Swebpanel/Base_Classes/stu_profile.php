    ...
    <section class="page container">
        ...
        <?php
         ...
         if(isset($_POST["uname"])){
          ...
          $query="UPDATE `student` SET `name`='$name',`uname`='$uname',`fname`='$fname',`email`='$email',`image`='$image',`password`='$password' WHERE `image`='$getID'";
          mysql_query($query,$con);

          $quer="UPDATE `smessage` SET `password`='$password' WHERE `image`='$getID' AND `type`='private' ";
          mysql_query($quer,$con);


          $que="UPDATE `smessage` SET `image`='$image',`tomsgimage`='$image' WHERE `image`='$getID' OR `tomsgimage`='$getID'";
          mysql_query($que,$con);
