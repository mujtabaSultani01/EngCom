...
<head>
    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='internet_collection'",$con);
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          mysql_query($query,$con);
           ...
           $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='internet_collection'",$con);
