...
<head>
            ...
            <div class="row">
             ...
             <center>
                    <h3>CIT (Cirtificate in Information Technology)<br/>
                            <small>Typing Pashto and Dari</small>
                        </h3></center> 
                    </header>
                </div>
    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='typing_pashto_dari'",$con);
...
<?php
         ...
         if(isset($_POST["clickMe"])){
          ...
          mysql_query($query,$con);
           ...
           $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='typing_pashto_dari'",$con);
