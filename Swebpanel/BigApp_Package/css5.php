                        ...
                        <ul class="nav nav-pills">
                         ...
                         <?php
                           ...
                           ?>
                                 <ul class="dropdown-menu">
                                        <li>
                                            <a href='stu_profile.php?stid=<?php echo $studentid ?> & Clname=css5.php '>update profile</a>
                                        </li>
                                        <li>
        ...
        <div class="row">
            <div class="span8">
                <div class="box">
                    <div class="box-header">
                        ...
                        <h5>css5 Class Images</h5>
                    </div>
                        <?php
                          include '../../adminpanel/ConPage.php';
                          $recordSet = mysql_query("SELECT * FROM `gallery` WHERE classname = 'css5' ");
            ...
            <div class="span8">
                <div class="blockoff-left">
                    <legend class="lead">
                      <p>Welcome To <b id="bo">css5</b> Class</p>
                    </legend>
                    <p>
                            ...
                            <div class="box-content box-table">
                                ...
                                <table id="sample-table" class="table table-hover table-bordered tablesorter">
                                    <thead>
                                       ...
                                       <?php
                                      $recordSet=
                                      mysql_query("SELECT stu_name,stu_Fname,marks FROM `stu_marks` WHERE (classname='css5' AND test_name='$testname') AND (stu_name='$user_name' AND stu_Fname='$user_fname')",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                   <?php do{ ?>
                                    <tbody>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                      $re=
                                      mysql_query("SELECT stu_name,stu_Fname,SUM(marks) as total FROM `stu_marks` WHERE classname='css5' AND (stu_name='$user_name' AND stu_Fname='$user_fname') GROUP BY stu_name ORDER BY total DESC",$con);
                    ...
                    <div class="span8">
                        <div class="box" id="coursefollwers" style="display:none">
                           ...
                           <table>
                             ...
                             include '../../adminpanel/ConPage.php';
                             $recordSet=
                             mysql_query("SELECT * FROM `student` as stu, `attend` as att WHERE stu.image!='$userimage' AND (stu.st_id=att.stid AND att.clname='css5')",$con);
                             $row=mysql_fetch_assoc($recordSet);
                           ...
                           <td></td> <td></td><td></td>
                           <td><i><a href="stu_message/msg-bet-stu-css5.php?stid=<?php echo $row["image"]; ?>"><img src="../public/images/icons/small/message.png"></a></i></td> 
                            </tr>
                            <?php }while($row=mysql_fetch_assoc($recordSet));?>
        ...
        <div class="row">
             <div class="span8" id="publicmessage" style="display:none">
               <div class="box">
                   ...
                   <div class="box-content">
                    ...
                    <?php
                        $recordSet=
                         mysql_query("SELECT * FROM `smessage` WHERE classname='css5' AND type='public' ",$con);
                        $row=mysql_fetch_assoc($recordSet);
                    ?>
                    <?php do{ ?>
         ...
         if(isset($_POST["pubody"])){
          ...
          mysql_query($query,$con);
               ...
               $Set=
            mysql_query("SELECT MAX(id) as mid FROM `smessage` WHERE classname='css5'",$con);
...
?>
              <div class="span8" id="privatemessage" style="display:none">
                <div class="box">
                    ...
                    <div class="box-content">
                        <div class="form-group">
                    <?php // SELECT * FROM `smessage`,`student` WHERE student.password=smessage.password AND classname='css5' 
