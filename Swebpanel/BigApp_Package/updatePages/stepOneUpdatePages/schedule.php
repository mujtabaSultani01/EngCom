...
<body>
             <?php
                         ...
                         $recordSet=mysql_query("SELECT * FROM `schedule` WHERE schid=$getID",$con);
    ...
    <div id="wrapper">
     ...
     <div class="navbar-default navbar-static-side" role="navigation">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><b id="st">Schedule Update  Form</b></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row" >
                <div class="col-lg-12">
                                    ...
                                    <form  method="POST" action="">
                                        ...
                                        <div class="form-group">
                                            <label> IssuesToBeCover </label>
                                              <textarea class="form-control" rows="3" name="issues"><?php echo $row["issue"]; ?></textarea>
                                        </div>
                                        <div class="form-group">
                          <label> Date </label>
                 ...
                 mysql_query("UPDATE `schedule` SET `day` = '$day', `issue` = '$issues',`date` = '$date'  WHERE `schedule`.`schid` = $getID; ",$con);
                   echo "record Updated...";
                    }
                ?>
                      </div>
