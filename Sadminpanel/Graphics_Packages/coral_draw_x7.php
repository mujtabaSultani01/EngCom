...
session_start();
  ...
  if (!isset($_SESSION['coralDrawX7loginAsTeacher'])) {
...
<body>
    ...
    <?php  
                    ...
                    $userimage=$_SESSION['coralDrawX7loginAsTeacher'];
    ...
    <div id="wrapper">
      ...
      <div class="navbar-header">
            ...
            <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(message) as total FROM `admin_teacher_msg` WHERE see_no='1' and (side='admin' AND classname='coral_draw_x7')",$con);
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                     ...
                     <?php
            $qnot=mysql_query("SELECT * FROM `admin_teacher_msg` as atmsg, users as us WHERE atmsg.ad_id=us.uid AND (atmsg.side='admin' AND atmsg.classname='coral_draw_x7')",$con);
            ...
            ?>
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                      ...
                      <li style="background-color:#D8BFD8;">
                            <a href="../layout/messages/admin_teacher_msg.php?aid=<?php echo $row['uid'] ?> & timage=<?php echo $row['image'] ?> & tid=<?php echo $tid ?> & clname=coral_draw_x7">
                                <div>
     ...
     ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><b id="st">coral_draw_x7</b> Class Forms</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-8">
                                    <form  method="POST" action="">
                                        ...
                                        <div class="form-group" style="display:none">
                                            ...
                                            <input class="form-control" type="text" value="coral_draw_x7" name="classname">
                                        </div>    
                                    ...
                                    <form role="form" method="post" action="">     
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="lessonid">
                                               <?php
                                        $record=
                                        mysql_query("SELECT * FROM `lessons` WHERE `classname`='coral_draw_x7' ",$con);
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" method="post" action="">  
                                         <div class="form-group">
                                            ...
                                            <select class="form-control" name="name">
                                               <?php
                                        $record=
                                        mysql_query("SELECT st.name from student as st, attend as at WHERE st.st_id=at.stid AND at.clname='coral_draw_x7'",$con);
                                        $rows=mysql_fetch_assoc($recordSet);
                                    ...
                                    <?php
                                        $record=
                                        mysql_query("SELECT st.fname from student as st, attend as at WHERE st.st_id=at.stid AND at.clname='coral_draw_x7'",$con);
                                        $rows=mysql_fetch_assoc($recordSet);
...
?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><b id="st">coral_draw_x7</b> Class Stored Data</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Schedule For <b id="st">coral_draw_x7</b> Class
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      include '../../adminpanel/ConPage.php';
                                      $recordSet=
                                      mysql_query("SELECT * FROM `schedule` WHERE classname='coral_draw_x7'",$con);
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?ID=<?php echo $row["schid"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Teacher_Instruction For <b id="st">coral_draw_x7</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `tinstruction` WHERE classname='coral_draw_x7'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?TID=<?php echo $row["id"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Lessons_Collection For <b id="st">coral_draw_x7</b> Class
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?LID=<?php echo $row["lid"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Documents For <b id="st">coral_draw_x7</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `documents` WHERE classname='coral_draw_x7'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?DID=<?php echo $row["did"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
               ...
               <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Students_Marks For <b id="st">coral_draw_x7</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <?php
                                      $records=
                                      mysql_query("SELECT DISTINCT test_name FROM `stu_marks` WHERE classname='coral_draw_x7'",$con);
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT stu_name,stu_Fname,marks,classname,ma_id FROM `stu_marks` WHERE classname='coral_draw_x7' AND test_name='$testname'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                   <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?MID=<?php echo $row["ma_id"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $re=
                                      mysql_query("SELECT stu_name,stu_Fname,SUM(marks) as total FROM `stu_marks` WHERE classname='coral_draw_x7' GROUP BY stu_name ORDER BY total DESC",$con);
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Extra_Tool For <b id="st">coral_draw_x7</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `extool` WHERE classname='coral_draw_x7'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?EID=<?php echo $row["eid"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
               ...
               <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Stored Images For <b id="st">coral_draw_x7</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `gallery` WHERE classname='coral_draw_x7'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?imgID=<?php echo $row["id"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
                ...
                <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(type) as total FROM `notification` WHERE row_count='1' AND (classname='coral_draw_x7' AND type='attendence')",$con);
            $rows=mysql_fetch_assoc($qunoti);
            $rowCount=$rows["total"];
            ...
            ?>
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Attendence For <b id="st">coral_draw_x7</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT DISTINCT at.Sname, at.Simage, at.Date, no.row_count,no.nid FROM `attendence` as at, notification as no WHERE no.fid=at.student_id AND (at.classname='coral_draw_x7' AND no.type='attendence')",$con);  
                                      $row=mysql_fetch_assoc($recordSet);
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"><?php echo $row["Sname"]; ?></a> </td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"><img style="width:50px; height:50px;" src="../../public/images/services/<?php echo $row["Simage"]; ?>" alt="" id="profile"></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"><?php echo $row["Date"]; ?></a> </td>
                                            <td style="background-color:#B0C4DE;">
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?AID=<?php echo $row["Sname"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                        <?php }else {?>
                                        <tr class="odd gradeX">
              ...
              <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(type) as total, row_count FROM `notification` WHERE row_count='1' AND (classname='coral_draw_x7' AND type='homework')",$con);
            $rows=mysql_fetch_assoc($qunoti);
            $roCount=$rows["total"];
            //$rowNu=$rows["row_count"];
            ?>
             <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Submitted Home Work For <b id="st">coral_draw_x7</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `homework` as ho,`notification` as no WHERE ho.hid=no.fid AND ho.classname='coral_draw_x7'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ...
                                    <tbody>
                                      <?php if ($row["row_count"]=='1') { ?>
                                           <tr class="odd gradeX">
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"> <?php echo $row["name"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"> <?php echo $row["fname"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"> <?php echo $row["body"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"> <a href="\EngCom\Sadminpanel\Videos/<?php echo $row["file"]; ?>"><?php echo $row["file"]; ?> </a></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"> <?php echo $row["voice"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"> <?php echo $row["Date"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;">
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?HID=<?php echo $row["name"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                      <?php }else {?>
                                        <tr class="odd gradeX">
        ...
        <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(type) as total, row_count FROM `notification` WHERE (row_count='1' AND classname='coral_draw_x7') AND (type='public' OR type='private')",$con);
            $rows=mysql_fetch_assoc($qunoti);
            $rCount=$rows["total"];
            //$rowNu=$rows["row_count"];
            ?>
                        ...
                        <div class="panel-heading">
                            Students Messages <b id="st">coral_draw_x7</b> Class
                      ...
                      <?php   //SELECT * FROM `smessage` as m,`student` as st WHERE m.password=st.password AND st.uname='$username'
                        $recordSet=
                         mysql_query("SELECT * FROM `smessage`as me, notification as no WHERE me.id=no.fid AND (no.type='public' AND me.classname='coral_draw_x7')",$con);
                        $row=mysql_fetch_assoc($recordSet);
                    ?>
                    <?php do{ ?><br>
                    <?php if ($row["row_count"]=='1') { ?>
                     <label style="color:brown;background-color:hsla(120,100%,75%,0.3); border-radius: 10px; width:385px;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"> <img src='../../public/images/services/<?php echo $row["image"]; ?>' style='border-radius: 13px; width:50px; height:50px'><?php echo $row["body"]; ?></a>
                      <a class="btn btn-danger" href="deletePages/stepOneDelete.php?PriID=<?php echo $row["body"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a><br></label>
...
?>
                    ...
                    <input class="form-control" type="text" value="public" name="public">
                            ...
                            <h3 style="color:#FF69B4"><b>Private Messages For the Class</b></h3>
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `smessage`as me, notification as no WHERE me.id=no.fid AND (no.type='private' AND me.classname='coral_draw_x7')",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <td>
                                              ...
                                              <label style="color:brown;background-color:hsla(120,100%,75%,0.3); border-radius: 10px; width:380px;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"> <img src='../../public/images/services/<?php echo $row["image"]; ?>' style='border-radius: 13px; width:50px; height:50px'><?php echo $row["body"]; ?></a><br></label>
                                            </td>
                                            <td>
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?MeID=<?php echo $row["body"]; ?> & Clname=coral_draw_x7.php"  class="icon_check_alt2">Delete</a>
                              ...
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                     ...
                                     <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `smessage` WHERE classname='coral_draw_x7' and type='betstu'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td>
                                                <a class="btn btn-danger" href="deletePages/stepOne-stu-msg-delete.php?ClNaID=<?php echo $row["classname"];?> & Clname=coral_draw_x7.php" class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
             ...
             <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(type) as total, row_count FROM `notification` WHERE row_count='1' AND (classname='coral_draw_x7' AND type='stAccount')",$con);
            $rows=mysql_fetch_assoc($qunoti);
            ...
            ?>
              <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <b id="st">coral_draw_x7</b> Class Students
                       <button class="btn btn-box-right" data-toggle="collapse" data-target=".box-hide-mr">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                             ...
                             include '../../adminpanel/ConPage.php';
                             $recordSet=
                             mysql_query("SELECT * FROM `student` as stu, `attend` as att, notification as no WHERE (stu.st_id=no.fid AND no.type='stAccount') AND (stu.st_id=att.stid AND att.clname='coral_draw_x7') ",$con);
                             $row=mysql_fetch_assoc($recordSet);


                             // $que=mysql_query("SELECT smg.image FROM `smessage` as smg,`student` as stu WHERE stu.st_id=smg.sid AND smg.image IN( SELECT stu.image FROM `student` as stu, `attend` as att WHERE stu.st_id=att.stid AND att.clname='coral_draw_x7')");
                            ...
                            <?php do{ ?>
                                    <tbody>
                                         <?php if ($row["row_count"]=='1') { ?>
                                        <tr class="odd gradeX">
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"><img style="width:50px; height:50px;" src="../../public/images/services/<?php echo $row["image"]; ?>" alt="" id="profile"></a> </td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"><?php echo $row["name"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"><?php echo $row["fname"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=coral_draw_x7.php"><?php echo $row["email"]; ?></a></td>
