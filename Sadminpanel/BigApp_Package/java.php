...
session_start();
  ...
  if (!isset($_SESSION['javaloginAsTeacher'])) {
...
<body>
    ...
    <?php  
                    ...
                    $userimage=$_SESSION['javaloginAsTeacher'];
    ...
    <div id="wrapper">
      ...
      <div class="navbar-header">
            ...
            <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(message) as total FROM `admin_teacher_msg` WHERE see_no='1' and (side='admin' AND classname='java')",$con);
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                     ...
                     <?php
            $qnot=mysql_query("SELECT * FROM `admin_teacher_msg` as atmsg, users as us WHERE atmsg.ad_id=us.uid AND (atmsg.side='admin' AND atmsg.classname='java')",$con);
            ...
            ?>
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                      ...
                      <li style="background-color:#D8BFD8;">
                            <a href="../layout/messages/admin_teacher_msg.php?aid=<?php echo $row['uid'] ?> & timage=<?php echo $row['image'] ?> & tid=<?php echo $tid ?> & clname=java">
                                <div>
     ...
     ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><b id="st">java</b> Class Forms</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-8">
                                    <form  method="POST" action="">
                                        ...
                                        <div class="form-group" style="display:none">
                                            ...
                                            <input class="form-control" type="text" value="java" name="classname">
                                        </div>    
                                    ...
                                    <form role="form" method="post" action="">     
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="lessonid">
                                               <?php
                                        $record=
                                        mysql_query("SELECT * FROM `lessons` WHERE `classname`='java' ",$con);
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-8">
                                    <form role="form" method="post" action="">  
                                         <div class="form-group">
                                            ...
                                            <select class="form-control" name="name">
                                               <?php
                                        $record=
                                        mysql_query("SELECT st.name from student as st, attend as at WHERE st.st_id=at.stid AND at.clname='java'",$con);
                                        $rows=mysql_fetch_assoc($recordSet);
                                    ...
                                    <?php
                                        $record=
                                        mysql_query("SELECT st.fname from student as st, attend as at WHERE st.st_id=at.stid AND at.clname='java'",$con);
                                        $rows=mysql_fetch_assoc($recordSet);
...
?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><b id="st">java</b> Class Stored Data</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Schedule For <b id="st">java</b> Class
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      include '../../adminpanel/ConPage.php';
                                      $recordSet=
                                      mysql_query("SELECT * FROM `schedule` WHERE classname='java'",$con);
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?ID=<?php echo $row["schid"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Teacher_Instruction For <b id="st">java</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `tinstruction` WHERE classname='java'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?TID=<?php echo $row["id"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Lessons_Collection For <b id="st">java</b> Class
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?LID=<?php echo $row["lid"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Documents For <b id="st">java</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `documents` WHERE classname='java'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?DID=<?php echo $row["did"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
              ...
              <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Students_Marks For <b id="st">java</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <?php
                                      $records=
                                      mysql_query("SELECT DISTINCT test_name FROM `stu_marks` WHERE classname='java'",$con);
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT stu_name,stu_Fname,marks,classname,ma_id FROM `stu_marks` WHERE classname='java' AND test_name='$testname'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                   <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?MID=<?php echo $row["ma_id"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $re=
                                      mysql_query("SELECT stu_name,stu_Fname,SUM(marks) as total FROM `stu_marks` WHERE classname='java' GROUP BY stu_name ORDER BY total DESC",$con);
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Extra_Tool For <b id="st">java</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `extool` WHERE classname='java'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?EID=<?php echo $row["eid"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
               ...
               <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Stored Images For <b id="st">java</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `gallery` WHERE classname='java'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?imgID=<?php echo $row["id"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
                ...
                <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(type) as total FROM `notification` WHERE row_count='1' AND (classname='java' AND type='attendence')",$con);
            $rows=mysql_fetch_assoc($qunoti);
            $rowCount=$rows["total"];
            ...
            ?>
             ...
             <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Attendence For <b id="st">java</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT DISTINCT at.Sname, at.Simage, at.Date, no.row_count,no.nid FROM `attendence` as at, notification as no WHERE no.fid=at.student_id AND (at.classname='java' AND no.type='attendence')",$con);  
                                      $row=mysql_fetch_assoc($recordSet);
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"><?php echo $row["Sname"]; ?></a> </td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"><img style="width:50px; height:50px;" src="../../public/images/services/<?php echo $row["Simage"]; ?>" alt="" id="profile"></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"><?php echo $row["Date"]; ?></a> </td>
                                            <td style="background-color:#B0C4DE;">
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?AID=<?php echo $row["Sname"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                        <?php }else {?>
                                        <tr class="odd gradeX">
              ...
              <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(type) as total, row_count FROM `notification` WHERE row_count='1' AND (classname='java' AND type='homework')",$con);
            $rows=mysql_fetch_assoc($qunoti);
            $roCount=$rows["total"];
            //$rowNu=$rows["row_count"];
            ?>
             <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Submitted Home Work For <b id="st">java</b> Class
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `homework` as ho,`notification` as no WHERE ho.hid=no.fid AND ho.classname='java'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ...
                                    <tbody>
                                      <?php if ($row["row_count"]=='1') { ?>
                                           <tr class="odd gradeX">
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"> <?php echo $row["name"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"> <?php echo $row["fname"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"> <?php echo $row["body"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"> <a href="\EngCom\Sadminpanel\Videos/<?php echo $row["file"]; ?>"><?php echo $row["file"]; ?> </a></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"> <?php echo $row["voice"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"> <?php echo $row["Date"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;">
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?HID=<?php echo $row["name"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                      <?php }else {?>
                                        <tr class="odd gradeX">
        ...
        <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(type) as total, row_count FROM `notification` WHERE (row_count='1' AND classname='java') AND (type='public' OR type='private')",$con);
            $rows=mysql_fetch_assoc($qunoti);
            $rCount=$rows["total"];
            //$rowNu=$rows["row_count"];
            ?>
                        ...
                        <div class="panel-heading">
                            Students Messages <b id="st">java</b> Class
                      ...
                      <?php   //SELECT * FROM `smessage` as m,`student` as st WHERE m.password=st.password AND st.uname='$username'
                        $recordSet=
                         mysql_query("SELECT * FROM `smessage`as me, notification as no WHERE me.id=no.fid AND (no.type='public' AND me.classname='java')",$con);
                        $row=mysql_fetch_assoc($recordSet);
                    ?>
                    <?php do{ ?><br>
                    <?php if ($row["row_count"]=='1') { ?>
                     <label style="color:brown;background-color:hsla(120,100%,75%,0.3); border-radius: 10px; width:385px;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"> <img src='../../public/images/services/<?php echo $row["image"]; ?>' style='border-radius: 13px; width:50px; height:50px'><?php echo $row["body"]; ?></a>
                      <a class="btn btn-danger" href="deletePages/stepOneDelete.php?PriID=<?php echo $row["body"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a><br></label>
...
?>
                    ...
                    <input class="form-control" type="text" value="public" name="public">
                            ...
                            <h3 style="color:#FF69B4"><b>Private Messages For the Class</b></h3>
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `smessage`as me, notification as no WHERE me.id=no.fid AND (no.type='private' AND me.classname='java')",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            <td>
                                              ...
                                              <label style="color:brown;background-color:hsla(120,100%,75%,0.3); border-radius: 10px; width:380px;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"> <img src='../../public/images/services/<?php echo $row["image"]; ?>' style='border-radius: 13px; width:50px; height:50px'><?php echo $row["body"]; ?></a><br></label>
                                            </td>
                                            <td>
                                                <a class="btn btn-danger" href="deletePages/stepOneDelete.php?MeID=<?php echo $row["body"]; ?> & Clname=java.php"  class="icon_check_alt2">Delete</a>
                              ...
                              <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                     ...
                                     <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `smessage` WHERE classname='java' and type='betstu'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td>
                                                <a class="btn btn-danger" href="deletePages/stepOne-stu-msg-delete.php?ClNaID=<?php echo $row["classname"];?> & Clname=java.php" class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
             ...
             <?php
            include '../../adminpanel/ConPage.php';
            $qunoti=mysql_query("SELECT COUNT(type) as total, row_count FROM `notification` WHERE row_count='1' AND (classname='java' AND type='stAccount')",$con);
            $rows=mysql_fetch_assoc($qunoti);
                       ...
                       <button class="btn btn-box-right" data-toggle="collapse" data-target=".box-hide-mr">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                             ...
                             include '../../adminpanel/ConPage.php';
                             $recordSet=
                             mysql_query("SELECT * FROM `student` as stu, `attend` as att, notification as no WHERE (stu.st_id=no.fid AND no.type='stAccount') AND (stu.st_id=att.stid AND att.clname='java') ",$con);
                             $row=mysql_fetch_assoc($recordSet);


                             // $que=mysql_query("SELECT smg.image FROM `smessage` as smg,`student` as stu WHERE stu.st_id=smg.sid AND smg.image IN( SELECT stu.image FROM `student` as stu, `attend` as att WHERE stu.st_id=att.stid AND att.clname='java')");
                            ...
                            <?php do{ ?>
                                    <tbody>
                                         <?php if ($row["row_count"]=='1') { ?>
                                        <tr class="odd gradeX">
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"><img style="width:50px; height:50px;" src="../../public/images/services/<?php echo $row["image"]; ?>" alt="" id="profile"></a> </td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"><?php echo $row["name"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"><?php echo $row["fname"]; ?></a></td>
                                            <td style="background-color:#B0C4DE;"><a href="notificationUpdate.php?notf=<?php echo $row["nid"] ?> & clname=java.php"><?php echo $row["email"]; ?></a></td>
