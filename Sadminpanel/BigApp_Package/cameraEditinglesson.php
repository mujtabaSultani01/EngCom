    ...
    <?php
         ...
         if(isset($_POST["bodyText"])){
          ...
          mysql_query($query,$con);
            ...
            $Set=
            mysql_query("SELECT MAX(hid) as hid FROM `homework` WHERE classname='camera_editing'",$con);
...
<?php
         ...
         $recSet=
            mysql_query("SELECT * FROM `attendence` WHERE classname='camera_editing'",$con);
