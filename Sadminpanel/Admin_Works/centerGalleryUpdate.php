...
#side-menu{
    ...
    height: 600px;
            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="centerGallery.php"><i class="fa fa-dashboard fa-fw"></i> Go Back</a>
                        </li>
                    </ul>
                    <!-- /#side-menu -->
                </div>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gallery Update Form</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
        ...
        <?php
         ...
         if(isset($_POST["image"])){
          ...
          {
            $query="UPDATE `a_gallery` SET `image`='$image',`type`='$type' WHERE `gid`=$getID";
