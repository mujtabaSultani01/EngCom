   ...
   <?php  
    ...
    <div id="wrapper">
     ...
     <?php
                                    $getID=$_GET["imgID"];
                                      $recordSet=
                                      mysql_query("SELECT * FROM `payment` WHERE employeeid=$getID and employeeType='student'",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
<style type="text/css">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <b>Students</b><b style="color:#8B0000;"> Fee </b><b id="st">Form</b>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a class="btn btn-success" href="studentsPaymentUpdate.php?imgID=<?php echo $row["payid"]; ?>"  class="icon_check_alt2">Update</a>
                                                <a class="btn btn-danger" href="stepOneDelete.php?paID=<?php echo $row["payid"]; ?> & Clname=studentsPayment.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                    ...
                                    <form role="form" method="post" action="">  
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group" style="display:none">
                                            ...
                                            <input class="form-control" type="text" value="student" name="userType">
                                        </div>  
