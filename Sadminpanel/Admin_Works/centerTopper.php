...
#side-menu{
    ...
    height: 600px;
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Top Students</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <b id="st">Top Students of the center</b>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td><img style="border-radius: 15px;" src="../../public/images/gallary/<?php echo $row["image"]; ?>" width="60" height="60"></td>
                                            ...
                                            <td>
                                                <a class="btn btn-success" href="centerTopperUpdate.php?ID=<?php echo $row["toid"]; ?>" class="icon_check_alt2">Update</a>
                                                <a class="btn btn-danger" href="stepOneDelete.php?toID=<?php echo $row["toid"]; ?> & Clname=centerTopper.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
         ...
         if(isset($_POST["uname"])){
          ...
          {
            $query="INSERT INTO `centerTopper` (`image`, `name`, `uname`,`score`, `category`, `date`, `classname`,`section`) 
            VALUES ('$image', '$name', '$uname','$score', '$category', '$date','$classname', '$section');";
