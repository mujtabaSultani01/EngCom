                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `student` AS st,`attend` AS at WHERE st.st_id=at.stid ",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a style="width:40px;" class="btn btn-success" href="stuAccountUpdate.php?imgID=<?php echo $row["st_id"]; ?>"  class="icon_check_alt2"><i class="fa fa-check"></i></a>
                                                <a style="width:40px;" class="btn btn-danger" href="stepOne-stu-account-delete.php?StID=<?php echo $row["st_id"]; ?> & Clname=studentCollection.php & Stimage=<?php echo $row["image"]; ?> & classname=<?php echo $row["clname"] ?>"  class="icon_check_alt2"><i class="fa fa-times"></i></a>
                                                <a style="width:40px;" class="btn btn-primary" href="studentsPayment.php?imgID=<?php echo $row["st_id"]; ?> & uID=<?php echo $uid ?>"  class="icon_check_alt2"><i class="fa fa-link"></i></a>
                                                <a style="width:40px;" class="btn btn-warning" href="studentHire.php?imgID=<?php echo $row["st_id"]; ?>"  class="icon_check_alt2"><i class="fa fa-heart"></i></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
