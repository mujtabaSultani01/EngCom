...
#side-menu{
    ...
    height: 600px;
            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="studentCollection.php"><i class="fa fa-dashboard fa-fw"></i> Go Back</a>
                        </li>
                    </ul>
                    <!-- /#side-menu -->
                </div>
        ...
        <div id="page-wrapper">
            ...
            $getID=$_GET["imgID"];
               $recordSet=
                 mysql_query("SELECT * FROM `student` AS st,`attend` AS at WHERE st.st_id=at.stid and st_id=$getID",$con);
                $row=mysql_fetch_assoc($recordSet);
                ?>
            <!-- /.row -->
            <div class="row" >
                                    ...
                                    <form  method="POST" action="">
                                        <div class="form-group" style="">
                                         ...
                                         <div class="form-group" style="">
                                            ...
                                            <input class="form-control" value="<?php echo $row["uname"]; ?>" type="text" name="uname">
                                        </div>
                                         <div class="form-group" style="">
                                            <label> Father Name </label>
                                            <input class="form-control" value="<?php echo $row["fname"]; ?>" type="text" name="fname">
                                        </div>
                                        <div class="form-group" style="">
                                            <label> Email </label>
         ...
         if(isset($_POST["uname"])){
          ...
          if ( $image =="" || $name =="" || $classname =="" || $email =="" || $fname =="" || $uname =="" ) {
            echo "<span style='color:red;'>please fill all the fields!!!</span>";
          }
          else
          {
            $query="UPDATE `attend` SET `clname`='$classname' WHERE `stid`=$getID";
            mysql_query($query,$con);
                     //header("location:index.php");

            $query="UPDATE `student` SET `name`='$name',`uname`='$uname',`fname`='$fname',`email`='$email',`password`='$password',`image`='$image' WHERE `st_id`=$getID";
            mysql_query($query,$con);
          echo "Done...";
        }
        }
