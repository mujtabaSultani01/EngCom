        ...
        <div id="page-wrapper">
              ...
              <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        include '../../adminpanel/ConPage.php';
                        $recordSet=
                        mysql_query("SELECT cl.cl_name as classname FROM `class` as cl WHERE cl.cl_name NOT IN( SELECT ta.clname FROM teacher_attend as ta )",$con);
                        $row=mysql_fetch_assoc($recordSet);
         ...
         if(isset($_POST["classname"])){
          ...
          else
          {
                 ...
                 $query="INSERT INTO `teacher_attend`(`clname`, `t_id`) VALUES ('$classname','$tid')";
