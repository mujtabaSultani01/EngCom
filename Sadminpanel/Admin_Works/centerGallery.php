...
#side-menu{
    ...
    height: 600px;
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Center Images</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             <b id="st">Images for the center</b>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <?php
                                      $recordSet=
                                      mysql_query("SELECT * FROM `a_gallery`",$con);
                                      $row=mysql_fetch_assoc($recordSet);
                                    ?>
                                    <?php do{ ?>
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a class="btn btn-success" href="centerGalleryUpdate.php?ID=<?php echo $row["gid"]; ?>" class="icon_check_alt2">Update</a>
                                                <a class="btn btn-danger" href="stepOneDelete.php?GaID=<?php echo $row["gid"]; ?> & Clname=centerGallery.php"  class="icon_check_alt2">Delete</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php }while($row=mysql_fetch_assoc($recordSet));?>
         ...
         if(isset($_POST["image"])){
          ...
          {
            $query="INSERT INTO `a_gallery` (`image`, `type`) 
            VALUES ('$image', '$type');";
