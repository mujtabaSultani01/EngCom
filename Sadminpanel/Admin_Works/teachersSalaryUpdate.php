   ...
   <?php  
    ...
    <div id="wrapper">
     ...
     <?php
                                    $getID=$_GET["imgID"];
                                      $recordSet=
                                      mysql_query("SELECT * FROM `payment` WHERE payid=$getID and employeeType='teacher'",$con);
            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="teacherCollection.php"><i class="fa fa-dashboard fa-fw"></i> Back</a>
                        </li>
                    </ul>
                    <!-- /#side-menu -->
                </div>
        ...
        <div id="page-wrapper">
                                ...
                                <div class="col-lg-8">
                                    <form role="form" method="post" action="">  
                                         <div class="form-group">
                                            <label> Paid </label>
                                            <input class="form-control" type="number" name="paid" value="<?php echo $rows["paid"]; ?>">
                                        </div>
                                       <div class="form-group">
                                            <label> Remained </label>
                                            <input class="form-control" type="number" name="remained" value="<?php echo $rows["remained"]; ?>">
                                        </div>
                                        <div class="form-group">
                                            <label> Start Date </label>
                                            <input class="form-control" value="<?php echo $rows["sdate"]; ?>" type="date" name="sdate">
                                        </div>
                                        <div class="form-group">
                                            <label> End Date </label>
                                            <input class="form-control" value="<?php echo $rows["edate"]; ?>" type="date" name="edate">
                                        </div> 
         ...
         if(isset($_POST["paid"])){
          ...
          else
          {
                 ...
                 $query="UPDATE `payment` SET `paid`='$paid',`remained`='$remained',`sDate`='$sdate',`eDate`='$edate' WHERE `payid`=$getID";
