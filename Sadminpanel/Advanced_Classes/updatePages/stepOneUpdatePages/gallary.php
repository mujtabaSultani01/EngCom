...
<body>
                        <?php
                         ...
                         $recordSet=mysql_query("SELECT * FROM `gallery` WHERE `gallery`.id=$getID",$con);
    ...
    <div id="wrapper">
     ...
     <div class="navbar-default navbar-static-side" role="navigation">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><b id="st">Images Update Form</b></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            <div class="row" >
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <form role="form" method="post" action="">      
                                        <div class="form-group">
                                            ...
                                            <img src="../../../../public/images/gallary/<?php echo $row["image"]; ?>" width="200" height="120"><br>
                 ...
                 mysql_query("UPDATE `gallery` SET `image` = '$file'  WHERE `gallery`.`id` = $getID; ",$con);
                   echo "record Updated...";
                    }
                ?>
                      </div>
